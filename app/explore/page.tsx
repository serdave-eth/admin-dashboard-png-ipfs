...
import { getCoinsMostValuable, getCoinsTopGainers, getCoinsMostActive } from '@zoralabs/coins-sdk';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-200 h-96 animate-pulse">
